...
#define UPDATE_DEBUG_MODE 0
    ...
    #define print_dbgmsg(str, args...) \
        ESP_LOGI ("terminal_dbg", str, __func__, ##args)
    #define print_dbgmsgnoarg(str)	\
        ESP_LOGI ("terminal_dbg", "%s in %s: ",str, __func__)
...
#define print_logmsg(str, args...) \
    ESP_LOGI ("terminal_log", str, __func__, ##args)
#define print_logmsgnoarg(str)	\
    ESP_LOGI ("termial_log", "%s in %s: ", str, __func__)
...
#define print_errmsgnoarg(str)	\
    ESP_LOGE ("terminal_err", "%s in %s: ",str, __func__)
#define print_errmsgnofunc(str, args...) \
